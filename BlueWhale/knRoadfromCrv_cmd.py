...
def RunCommand(is_interactive):
    ...
    values = ui_osm3d.show_eto_form_with_titles("Road Creation Toolbox", "Width of Road", "Radius of Rotation")
    if not values:
    ...
    try:
        for crv_id in crv_ids:
            ...
            # Fillet
            filleted = rg.Curve.CreateFilletCornersCurve(crv_geom, radius, sc.doc.ModelAbsoluteTolerance, sc.doc.ModelAngleToleranceDegrees)
            if not filleted: filleted = crv_geom
